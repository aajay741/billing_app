...
$id = (int)($_GET['id'] ?? 0);
if ($id <= 0) {
    echo "<div class='p-3 small'>Invalid purchase ID.</div>";
...
// Header
$stmt = $pdo->prepare("SELECT pi.*, s.name AS supplier_name, s.address AS supplier_address,
                              s.city AS supplier_city, s.state AS supplier_state, s.gstin AS supplier_gstin
...
if (!$inv) {
    echo "<div class='p-3 small'>Purchase not found.</div>";
    require __DIR__ . '/../footer.php';
    exit;
}
...
<div class="p-3 bg-white border rounded shadow-sm small" id="print-area">
    <div class="d-flex justify-content-between mb-2">
        ...
        <div class="text-end">
            <h6 class="mb-1">Purchase Invoice</h6>
    ...
    <div class="row mb-2">
        <div class="col-md-6">
            ...
            <div>GSTIN: <?=htmlspecialchars($inv['supplier_gstin'])?></div>
        </div>
    </div>
...
<div class="mt-2 d-print-none">
    <a href="index.php?page=purchases" class="btn btn-sm btn-secondary">Back</a>
